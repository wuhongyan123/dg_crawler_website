...
# author:刘鼎谦
class MdngovmmenSpider(BaseSpider):
    name = 'mdngovmmen'
    # allowed_domains = ['www.mdn.gov.mm/en']
    start_urls = ['http://www.mdn.gov.mm/en/']

    website_id = 1493  # 网站的id(必填)
    ...
    noNews = ['http://www.mdn.gov.mm/en/video-demand', 'http://www.mdn.gov.mm/en/live',
              'http://www.mdn.gov.mm/en/video', 'http://www.mdn.gov.mm/index.php/newspaper/public',
              'http://www.mdn.gov.mm/index.php/en/home','http://www.mdn.gov.mm/en/ethnic-affairs']

...
class PaukphawcnSpider(BaseSpider):
    ...
    def parse_item(self, response):
        ...
        item['category2'] = soup.select_one('body > div.page-container > div > div > ul > li:nth-child(3) > a').text
        ...
        p_list = []# div.col-md-9 > div.article > section.article-content > p:nth-child(7) > span
        if soup.select('div.col-md-9 > div.article > section.article-content > p'):
            all_p = soup.select('div.col-md-9 > div.article > section.article-content > p')

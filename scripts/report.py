...
file = '{}.xls'
# 累计数据获取报告和累计获取量。
daily_fields_list = ['website_id', 'url', 'c_name', 'country', 'language', 'remark', 'developer', 'start_time', 'news_amount']
all_fields_list= ['website_id', 'url', 'c_name', 'country', 'language', 'remark', 'developer', 'start_time', 'news_amount']

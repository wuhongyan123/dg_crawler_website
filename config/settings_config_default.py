...
BASE_DOWNLOADER_MIDDLEWARES = {
    'crawler.middlewares.filter_download_middleware.FilterDownloaderMiddleware': 543,
...
BASE_ITEM_PIPELINES = {
    ...
    # 'crawler.pipelines.html_pipeline.HtmlPipeline': 400,
}

BASE_SPIDER_MIDDLEWARES = {
    'crawler.middlewares.item_spider_middleware.ItemSpiderMiddleware': 543,
}